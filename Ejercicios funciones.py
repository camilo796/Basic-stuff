...
def array_check(nums):
    return print("1, 2, 3" in str(nums))
array_check([1, 1, 2, 3, 2, 6])
...
def end_other(a, b):
    print((b[-len(a):] in a[-len(b):]) or (a[-len(b):] in b[-len(a):]))

end_other('ilocam','cam')
